...
class Connect extends Component {
    ...
    componentDidMount(){
        ...
        //this.props.loginProvider(values.access_token);
        this.props.loginProvider(this.props.location.search);
    }
...
export default connect(mapStateToProps,{loginProvider})(Connect)